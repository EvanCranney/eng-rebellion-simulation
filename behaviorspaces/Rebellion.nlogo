...
"cops" 1.0 0 -11221820 true "" "plot count cops"
...
@#$#@#$#@
<experiments>
  <experiment name="experiment 06" repetitions="1" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
  ...
  <experiment name="experiment 14" repetitions="1" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="40000"/>
    <metric>count agents with [jail-term &gt; 0]</metric>
  ...
  <experiment name="experiment 15" repetitions="1" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
  ...
  <experiment name="experiment 09" repetitions="1" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="40000"/>
    <metric>count agents with [jail-term &gt; 0]</metric>
  ...
  <experiment name="experiment 01" repetitions="1" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="40000"/>
    <metric>count agents with [jail-term &gt; 0]</metric>
  ...
  <experiment name="experiment 07" repetitions="1" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="40000"/>
    <metric>count agents with [jail-term &gt; 0]</metric>
  ...
  <experiment name="experiment 02" repetitions="1" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="40000"/>
    <metric>count agents with [jail-term &gt; 0]</metric>
  ...
  <experiment name="experiment 08" repetitions="1" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="20000"/>
    <metric>count agents with [jail-term &gt; 0]</metric>
  ...
  <experiment name="experiment 03" repetitions="1" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="40000"/>
    <metric>count agents with [jail-term &gt; 0]</metric>
  ...
  <experiment name="experiment 04" repetitions="1" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="40000"/>
    <metric>count agents with [jail-term &gt; 0]</metric>
  ...
  <experiment name="experiment 10" repetitions="1" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="40000"/>
    <metric>count agents with [jail-term &gt; 0]</metric>
  ...
  <experiment name="experiment 05" repetitions="1" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="40000"/>
    <metric>count agents with [jail-term &gt; 0]</metric>
  ...
  <experiment name="experiment 12" repetitions="1" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="40000"/>
    <metric>count agents with [jail-term &gt; 0]</metric>
  ...
  <experiment name="experiment 13" repetitions="1" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="20000"/>
    <metric>count agents with [jail-term &gt; 0]</metric>
  ...
  <experiment name="experiment 16" repetitions="1" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="100"/>
    <metric>count agents with [jail-term &gt; 0]</metric>
    ...
    <metric>count agents with [not active? and jail-term = 0]</metric>
    <metric>count cops</metric>
    <steppedValueSet variable="government-legitimacy" first="0.2" step="0.35" last="0.95"/>
    <enumeratedValueSet variable="movement?">
      <value value="true"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="initial-agent-density">
